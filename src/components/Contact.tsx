...
import { Github, Linkedin, MapPin, Send, Twitter } from "lucide-react";
  ...
  const contactInfo = [
    {
      icon: MapPin,
      label: "Location",
      value: "Nairobi, Kenya. Available for Remote Work",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              {contactInfo.map((info) => {
                ...
                const content = (
                  <div className="mb-4 flex items-start gap-4 p-6 hover:scale-105 rounded-lg border border-gray-600 hover:border-foreground transition-all duration-300">
                    <div className="w-12 h-12 bg-primary text-primary-foreground rounded-md flex items-center justify-center shrink-0">
                      <Icon size={20} />
                    </div>
                    <div>
            ...
            <div className="rounded-xl p-6 border border-gray-700">
              ...
              <div className="flex gap-4">
                <a href="https://www.linkedin.com/in/felista-njeri" target="_blank" className="w-12 h-12 border border-gray-600 rounded-lg flex items-center justify-center hover:border-foreground">
